...
public class ResponseTicket {
	...
	public ResponseTicket(Integer flightNumber, String airlineName, String depratureAirport, 
			String arrivalAirport, Date departureTime, Date departureDate, 
			Date arrivalTime, Date arrivalDate, Date issuedAt,
	...
	public void setReservation(String reservationCode) {
		this.reservationCode = reservationCode;
	}
